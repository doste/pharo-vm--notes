...
[This part may be a little confusing: Even in the SimpleStackCogit there will be 'moves' to registers, to operate on a processor we do so by using the registers! 
